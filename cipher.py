class Cipher:
	...
	# Used to verify if the cipher works, by encoding, then decoding, and checking if the input matches the output.
	def verify(self, msg, key):
		encoded = self.encode(msg, key)
		return msg == self.decode(encoded, key)
